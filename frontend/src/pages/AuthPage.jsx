  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#0c4a6ecc,#1e40afcc,#0ea5e9cc)] px-4 py-6 sm:px-6 sm:py-8 md:p-6 flex items-center justify-center">
      <motion.div
        ...
        className="relative w-full max-w-[420px] sm:max-w-[540px] md:max-w-[820px] bg-white rounded-[24px] md:rounded-[30px] shadow-2xl overflow-hidden"
      >
        <div className="relative md:min-h-[560px]">
          ...
          <div
            className={`
              ...
              md:absolute md:top-0 md:left-0 md:h-full md:w-1/2
              items-center justify-center
              px-5 py-8 sm:px-8 sm:py-10 md:px-12
              transition-all duration-700
              ${isSignup ? "md:translate-x-full md:opacity-100" : "md:opacity-0 md:pointer-events-none"}
            `}
          >
            <div className="w-full max-w-[360px] md:max-w-[380px]">
              ...
              <button
                onClick={handleGoogleAuth}
                className="group border px-6 py-3 rounded-full flex items-center gap-3 justify-center w-full bg-white hover:bg-gray-50 transition-all duration-300 hover:shadow-lg hover:scale-[1.04] active:scale-[0.97]"
              >
                <svg
                  className="w-5 h-5 transition-transform duration-300 group-hover:rotate-12"
                  viewBox="0 0 48 48"
